...
<body><br>
	<div class="container">
		  ...
		  <div class="container-fluid">
		    ...
		    <div class="collapse navbar-collapse" 
		      ...
		      <ul class="navbar-nav me-auto mb-2 mb-lg-0">
		        ...
		        <li class="nav-item">
		          <a class="nav-link" 
		             href="add-category.php">Add Grade</a>
		        </li>
		        <li class="nav-item">
		          <a class="nav-link" 
		             href="add-author.php">Add Section</a>
		        </li>
		        <li class="nav-item">
		          <a class="nav-link" 
       ...
       <form action="search.php"
             method="get" 
             style="width: 100%; max-width: 30rem; box-shadow: 0 0 10px  #00BBD3;">
    ...
    font-size: 25px;
    text-align: center;
    cursor: default;">All Books</h4>
		<table class="table table-bordered" style="box-shadow: 0 0 10px  #00BBD3; color: black;">
			<thead>
				<tr>
					<th>Num</th>
					<th>Title</th>
			  ...
			  <tr>
				...
				<td>
					...
					<a  class="link-dark d-block
					           text-center" style="text-decoration: none;"
	   ...
	   <?php }?>
		...
		<h4 class="mt-5" style="font-family: sans-serif;
    color: #00BBD3;
    font-size: 25px;
    text-align: center;
    cursor: default;">All Grade</h4>
		<table class="table table-bordered" style="box-shadow: 0 0 10px  #00BBD3;">
			<thead>
				<tr>
					<th>Num</th>
					<th>Grade Name</th>
	    ...
	    <?php  if ($authors == 0) { ?>
        	<div class="alert alert-warning 
        	     ...
        	     <img src="img/empty.png" 
        	          width="100">
        	     <br>
			  There is no Seaction in the database
		    </div>
        <?php }else {?>
	    <!-- List of all Authors -->
		<h4 class="mt-5" style="font-family: sans-serif;
    ...
    font-size: 25px;
    text-align: center;
    cursor: default;">All Seaction</h4>
         <table class="table table-bordered" style="box-shadow: 0 0 10px  #00BBD3;">
			<thead>
				<tr>
					<th>Num</th>
